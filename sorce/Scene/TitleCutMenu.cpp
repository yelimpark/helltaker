...
void TitleCutMenu::Init()
{
	...
	for (int i = 0; i < MAX_NUMBER_OF_ITEMS; i++)
	{
		...
		menu[i].setOrigin(textRect.width / 2, textRect.height / 2);*/
	...
	menu[0].setPosition(resolution.x * 0.4, 700);
	menu[1].setPosition(resolution.x * 0.4, 800);
	menu[2].setPosition(resolution.x * 0.4, 900);
